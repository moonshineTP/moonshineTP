...
- [Learn Next.js](https://nextjs.org/learn) - the Next.js tutorial.

You can check out [the Next.js GitHub repository](https://github.com/vercel/next.js) for the source code.

## Deploy on Vercel

The project is configured for Cloudflare Workers and GitHub Pages. Vercel deployment is not part of the active CI/CD targets.
